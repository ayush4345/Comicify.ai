            ...
            <div className="container px-3 py-2 mx-auto">
                <div className="flex flex-col items-center text-center">
                    <div className="flex flex-col mt-4 items-center sm:flex-row sm:justify-center gap-5">
                        ...
                        <a href="https://www.buymeacoffee.com/comicifyAI" target="_blank" className=" sm_max:w-52"><img src="https://img.buymeacoffee.com/button-api/?text=Buy me a coffee&emoji=&slug=comicifyAI&button_colour=4abfa8&font_colour=000000&font_family=Comic&outline_colour=000000&coffee_colour=FFDD00" /></a>
